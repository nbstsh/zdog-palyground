...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/zdog/js/boilerplate.js":[function(require,module,exports) {
/*!
 * Zdog v1.1.0
...
animate();
},{"zdog":"node_modules/zdog/js/index.js"}],"js/kirby.js":[function(require,module,exports) {
"use strict";
...
var sceneSize = 80;
var isSpinning = true;
var TAU = _zdog.default.TAU; // colors
...
var body = new _zdog.default.Shape({
  stroke: 22,
  translate: {
    y: 11
  },
...
var face = new _zdog.default.Anchor({
  translate: {
    z: 10.5
  },
  addTo: body
...
[-1, 1].forEach(function (xSide) {
  ...
  var cheekHolder = new _zdog.default.Anchor({
    addTo: body,
    rotate: {
      y: 0.6 * xSide
    }
...
var rightArm = new _zdog.default.Shape({
  path: [{
    y: 0
  }, {
    y: -7
...
var rightFoot = new _zdog.default.Shape({
  path: [{
    x: 0,
    y: -2
  }, {
...
var umbrella = new _zdog.default.Shape({
  path: [{
    y: 0
  }, {
    y: 22
...
var star = new _zdog.default.Shape({
  path: starPath,
  addTo: umbrella,
  translate: {
    y: -4.5
...
(function () {
  for (var i = 0; i < 6; i++) {
    var starHolder = new _zdog.default.Anchor({
      addTo: umbrella,
      translate: {
        y: 10
      },
...
animate();
},{"zdog":"node_modules/zdog/js/index.js"}],"js/kirby-face.js":[function(require,module,exports) {
"use strict";
...
var COLOR_BLUSH = '#F5A';
var COLOR_BLACK = '#333';
var COLOR_RED = '#D03'; // 1 TAU = 1 round

var TAU = _zdog.default.TAU;

var generateIllo = function generateIllo() {
  return new _zdog.default.Illustration({
    element: '.kirby-face-canvas',
    zoom: 3
  });
};

var addBodyToIllo = function addBodyToIllo(illo) {
  return new _zdog.default.Shape({
    stroke: 22,
    addTo: illo,
    color: COLOR_PINK
  });
...
var addFaceToBody = function addFaceToBody(body) {
  return new _zdog.default.Anchor({
    translate: {
      z: 10.5
    },
    addTo: body
...
var addEyeToFace = function addEyeToFace(face, rate) {
  var eyeGroup = new _zdog.default.Group({
    addTo: face,
    translate: {
      x: 2.4 * rate,
...
var addCheeckToFace = function addCheeckToFace(face, rate) {
  new _zdog.default.Ellipse({
    width: 2.5,
    height: 1,
    translate: {
...
var addMouthToFace = function addMouthToFace(face) {
  // mouth
  new _zdog.default.Shape({
    path: [{
      x: 0,
...
var initIllo = function initIllo() {
  var illo = generateIllo();
  var body = addBodyToIllo(illo);
  var face = addFaceToBody(body);
  addEyeToFace(face, 1);
  addEyeToFace(face, -1);
...
animate();
var canvasEl = document.querySelector('.kirby-face-canvas');
canvasEl.addEventListener('mousemove', function (e) {
  movementX = -1 * e.movementX;
  movementY = -1 * e.movementY;
});
},{"zdog":"node_modules/zdog/js/index.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
require("./kirby-face");
},{"../sass/main.scss":"sass/main.scss","./zdog":"js/zdog.js","./kirby":"js/kirby.js","./kirby-face":"js/kirby-face.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
